...
#       " Please rebuild Math::MPFR against a modern mpfr library (v4.2.0 or later)\n";
 ...
 my $pack = pack_f16_hex('0000');
  cmp_ok(ref($pack), 'eq', "Math::FakeFloat16", "'0000': pack returns Math::FakeFloat16 object");
  cmp_ok(is_f16_zero($pack), '==', 1, "returns 0 as expected");

  $pack = pack_f16_hex('8000');
  cmp_ok(ref($pack), 'eq', "Math::FakeFloat16", "'8000': pack returns Math::FakeFloat16 object");
  cmp_ok(is_f16_zero($pack), '==', -1, "returns -0 as expected");
